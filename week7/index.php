...
if ( isset($_GET['md5']) ) {
    ...
    // Outer loop go through the digit for the
    ...
    for($i=0; $i<strlen($txt); $i++ ) {
        ...
        for($j=0; $j<strlen($txt); $j++ ) {
            ...
            // Our inner loop for third character
            for($k=0; $k<strlen($txt); $k++) {
                $ch3 = $txt[$k]; // Our third character

                // Our inner loop for fourth character
                for($l=0; $l<strlen($txt); $l++) {
                    $ch4 = $txt[$l]; // Our fourth character

                    // Concatenate these four characters together to
